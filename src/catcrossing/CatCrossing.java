...
public class CatCrossing extends Canvas implements Runnable {
	...
	private void init() {
		...
		cat = new Cat(spriteManager.grabSheet("bunny move"), new Vector2(200, 200), camera, tileMap, interactables);
	...
	private void loadCollectables() {
		...
		collectables.add(Collectable.createAxe(new Vector2(200, 200), camera));
		collectables.add(Collectable.createAxe(new Vector2(300, 300), camera));
		collectables.add(Collectable.createHoe(new Vector2(400,  400), camera));
		collectables.add(Collectable.createWateringCan(new Vector2(100, 100), camera));
		collectables.add(Collectable.createWheatSeeds(new Vector2(300, 100), camera));
	}
	...
	private void loadEntities() {
		...
		List<Tree> trees = List.of(new Tree(new Vector2(400, 200), camera, cat, collectables),
				new Tree(new Vector2(300, 200), camera, cat, collectables));
		for(Tree tree : trees) {
			entities.add(tree);
		}
		List<Chicken> chickens = List.of(new Chicken(new Vector2(100,100),200,camera, cat, collectables));
