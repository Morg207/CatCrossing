...
public class Cat extends Entity implements KeyListener {
	...
	public Cat(BufferedImage[][] moveImages, Vector2 position, Camera camera, TileMap tileMap, List<Interactable> interactables) {
	...
	private void drawStamina(Graphics2D g2d) {
